    ...
    onMutation(state, context) {
        ...
        toolCards.forEach(card => {
            ...
            if (!execToCurrentBtn) {
                ...
                execToCurrentBtn.innerHTML = `<svg width="42.24" height="31.68" viewBox="0 0 35.2 26.4" fill="none" xmlns="http://www.w3.org/2000/svg" class="stroke-current size-4"><path d="M 19.2 2.2 A 11 11 0 0 0 8.2 13.2 A 11 11 0 0 0 19.2 24.2" stroke-width="1.65"/><path d="M 14.9 2.2 A 11 11 0 0 0 3.9 13.2 A 11 11 0 0 0 14.9 24.2" stroke-width="1.65"/><circle cx="22" cy="13.2" r="11" stroke-width="1.65"/><path d="M20.933 9.5172C20.5939 9.30526 20.1665 9.29404 19.8167 9.4879C19.467 9.68174 19.25 10.0501 19.25 10.45V16.05C19.25 16.4499 19.467 16.8183 19.8167 17.0121C20.1665 17.206 20.5939 17.1947 20.933 16.9828L25.333 14.1328C25.6546 13.9318 25.85 13.5793 25.85 13.2C25.85 12.8207 25.6546 12.4682 25.333 12.2672L20.933 9.5172Z" stroke-width="1.65" stroke-linejoin="round" fill="none"/></svg>`;
